...
import src.view.project.about_window as about_data
...
class ProjectWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.icon = QtGui.QIcon("view/resources/icons/hexagon.png")
    ...
    def _create_actions(self):
        ...
        self.print_action = QAction(QtGui.QIcon("view/resources/icons/print.png"), "Print")
        ...
        self.zoom_in_action = QAction(QtGui.QIcon("view/resources/icons/zoom_in.png"), "Zoom in")
        self.zoom_out_action = QAction(QtGui.QIcon("view/resources/icons/zoom_out.png"), "Zoom out")
        self.zoom_fit_action = QAction(QtGui.QIcon("view/resources/icons/zoom.png"), "Zoom fit")
