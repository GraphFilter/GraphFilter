equation = "<p> On this screen, you can insert a condition like as mathematical equation or inequality, using " \
               ...
               "\u03c9(G) == a(\u2113(G)) OR \u03bb \u2081(G) > (\u03bb\u2081(c(G)))/2 <br> <br> You can access our " \
               "<a href=""https://github.com/GraphFilter/GraphFilter/wiki/Dictionary""> dictionary</a> " \
               "to find out more about each invariants.</p>"
...
conditions = "<p> In this screen you will enter the conditions of the true/false type. If you want filtering to " \
                 ...
                 "Feel free to check as many conditions as you like. <br> <br> You can access our " \
                 "<a href=""https://github.com/GraphFilter/GraphFilter/wiki/Dictionary""> dictionary</a> " \
                 "to find out more about each invariants.</p>"
...
files = "<p> In this screen you must insert the files containing the lists of the graphs to be analyzed. The " \
            ...
            "If you don't have any files in these formats on your computer, we've provided two buttons in the bottom " \
            "right-hand corner of the screen with reliable sources that have a variety of downloadable graph lists " \
            "that can be used in the software. <br> <br>" \
            "It is strongly recommended that you avoid compressed files (.gz) as it considerably increases the" \
            " filtering time. Use a file decompressor software (7zip, winzip or winrar) and load here with a " \
            ".txt or .g6 file."
