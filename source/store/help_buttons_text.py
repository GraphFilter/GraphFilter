tip_equation = "<p> On this screen, you can insert a condition like as mathematical equation or inequality, using " \
...
tip_method = "<p> The 'Filter graphs'' will filter a list of graphs and return all those that satisfy the conditions " \
...
tip_conditions = "<p> In this screen you will enter the conditions of the true/false type. If you want filtering to " \
